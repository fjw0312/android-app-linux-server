...
public class FileDeal {
		...
		String his_equip_path = "/data/fjw/Data/HisEquipt/";     //type:1
		String his_signal_path = "/data/fjw/Data/HisSignal/";   //type:2
		String his_event_path = "/data/fjw/Data/history/";        //type:3 	
		String his_formulaLine_path = "/data/fjw/Data/HisFormula/Line/"; //pue运算式子曲线 保存文件路径                             //type:10
		String his_formulaDay_path = "/data/fjw/Data/HisFormula/Day/";  //天用电量/pue分布  运算式子曲线 保存文件路径  //type:11
		String his_formulaMon_path = "/data/fjw/Data/HisFormula/Mon/";  //月用电量/pue分布 运算式子曲线 保存文件路径   //type:12
		String his_formulaYear_path = "/data/fjw/Data/HisFormula/Year/"; //年用电量/pue分布运算式子曲线 保存文件路径    //type:13
