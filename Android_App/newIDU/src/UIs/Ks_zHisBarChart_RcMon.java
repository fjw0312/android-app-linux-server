...
//自定义控件  月用电量     柱状图
public class Ks_zHisBarChart_RcMon extends ViewGroup implements VObject{

	public Ks_zHisBarChart_RcMon(Context context) {
		super(context); 
	...
	{		
		...
		try{
			...
			Log.e("Ks_HisBarChart_Mon>>onDraw>>","绘制曲线 异常抛出！");
		}
...
//		Log.e("Ks_zHisBarChart_RcYear-doLayout","into");
	...
	public boolean  updataValue(String strValue) {
		...
		if(HisDataDAO.hisFormulaId_lst==null || HisDataDAO.hisFormulaId_lst.size()==0) return false;
